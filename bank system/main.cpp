...
int main() {
	...
	//register clients
	cout << "\n\n\n* \t\t register clients \t\t *\n\n\n";
	int client1 = bank.register_client(new Person("Yakubiv", "Yulia", "Andreevna", Date({ 10,04,2002 }), "8(123)456-78-90", "2727 272727"));
	int client2 = bank.register_client(new Person("Bain", "Danila", "Denisovich", Date({ 26,07,2002 }), "8(980)65-44-222", "7676 767676"));
	int client3 = bank.register_client(new LegalEntity("Macdonalds", Date({ 12,12,2012 }), "<Address>", "12345678901234"));
...
// transactions
	...
	cout << endl << "transaction: " << 7000 << " from " << account1 << " to " << account2 << endl << endl;
	...
	cout << endl << "transaction: " << 10000 << " from " << account1 << " to " << account2 << endl << endl;
	...
	cout << endl << "transaction: " << 10001 << " from " << account1 << " to " << account2 << endl << endl;
...
// update client information scenario:
	...
	Client* changed_client = new LegalEntity("Uncle Vanya", Date({ 12,12,2012 }), "<Address>", "12345678901234");
...
// cards
	...
	cout << endl << "card transaction: " << 10000 << " from " << account1 << " to " << account2 << endl << endl;
	...
	cout << endl << "change card1 account from " << account1 << " to " << account2 << endl << endl;
...
// close account scenario:
	...
	cout << "Closing account number " << account1 << " using transaction..." << endl << endl;
	...
	cout << "Closing account number " << account2 << " using cash..." << endl << endl;
